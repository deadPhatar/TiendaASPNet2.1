...
--Parece ser que la siguiente entidad no se utiliza en }
--la base de datos o en la aplicación web
...
--La siguiente entidad no tiene un propósito realmente funcional
--para el estado actual del proyecto. Solamente, por mera
--propgramación, es necesaria para poder realizar algunas acciones
--(debe haber a menos un usuario en la tabla).
